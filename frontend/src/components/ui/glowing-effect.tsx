    ...
    ({
        ...
        return (
            <>
                ...
                radial-gradient(circle at 60% 40%, #a21caf 10%, #a21caf00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #a78bfa 0%,
                  #c084fc calc(20% / var(--repeating-conic-gradient-times)),
                  #f472b6 calc(40% / var(--repeating-conic-gradient-times)),
                  #818cf8 calc(60% / var(--repeating-conic-gradient-times)),
                  #a21caf calc(80% / var(--repeating-conic-gradient-times)),
